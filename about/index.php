    ...
    <div class="page-wrapper">
        ...
        <!-- service section start -->
         <section class="services-section section-padding">
            <div class="container">
            <h5 class="section-feature text-center">Our Services</h5>
                    <h2 class="section-heading text-center">Lorem ipsum dolor sit.</h2>
                    <p class="section-para2">Lorem, ipsum dolor sit amet consectetur adipisicing elit. At illum esse ducimus.</p>
